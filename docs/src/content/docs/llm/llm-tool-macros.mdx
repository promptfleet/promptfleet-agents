...
<Aside type="tip">Proc-macro crate — runs at compile time on the host. Generated code is WASM-compatible.</Aside>
...
See the [LLM Tools guide](/promptfleet-agents/guides/llm-tools/) for end-to-end examples of defining, registering, and invoking LLM tools.
