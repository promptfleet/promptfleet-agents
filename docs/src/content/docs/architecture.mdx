...
graph TD
  ...
  a2a_http_client --> protocol_transport_core
  a2a_http_client -.-> observability
  a2a_http_server --> a2a_protocol_core
  a2a_http_server --> protocol_transport_core
  a2a_http_server --> a2a_app_ports
  a2a_http_server -.-> observability
  ...
  pf_test_harness --> llm_client
  pf_test_harness -.-> agent_sdk
  pf_test_harness -.-> a2a_protocol_core
  pf_test_harness -.-> a2a_http_server
