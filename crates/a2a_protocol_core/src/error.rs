...
pub mod a2a_error_codes {
    ...
    pub const AGENT_UNAVAILABLE: i64 = TASK_NOT_FOUND;
    pub const METHOD_NOT_AVAILABLE: i64 = TASK_NOT_CANCELABLE;
    pub const CAPABILITY_VALIDATION_FAILED: i64 = PUSH_NOTIFICATION_NOT_SUPPORTED;
    pub const METHOD_EXECUTION_FAILED: i64 = UNSUPPORTED_OPERATION;
    pub const REGISTRY_ERROR: i64 = CONTENT_TYPE_NOT_SUPPORTED;
    pub const PROTOCOL_VALIDATION_ERROR: i64 = INVALID_AGENT_RESPONSE;
}
