...
<Aside type="tip">WASM-compatible — compiles to both `wasm32-wasip1` and native targets. Includes `wasm-bindgen` and `js-sys` support for browser/WASM environments.</Aside>
